...
class AINDNet_recon(nn.Module):
    def __init__(self, in_nc, out_nc):
        ...
        self.conv1 = nn.Conv2d(in_nc, 32, 3, 1, 1, bias=True)
        self.ain_rb1_1 = AIN_ResBlock(32)
        self.ain_rb1_2 = AIN_ResBlock(32)
        self.avg_pool2 = nn.AvgPool2d(2)

        self.conv2 = nn.Conv2d(32, 64, 3, 1, 1, bias=True)
        self.ain_rb2_1 = AIN_ResBlock(64)
        self.ain_rb2_2 = AIN_ResBlock(64)

        self.conv3 = nn.Conv2d(64, 128, 3, 1, 1, bias=True)
        self.ain_rb3_1 = AIN_ResBlock(128)
        self.ain_rb3_2 = AIN_ResBlock(128)
        self.ain_rb3_3 = AIN_ResBlock(128)
        self.ain_rb3_4 = AIN_ResBlock(128)
        self.ain_rb3_5 = AIN_ResBlock(128)

        self.res_up1 = ResUpsampleSum(64, 128)
        self.ain_rb4_1 = AIN_ResBlock(64)
        self.ain_rb4_2 = AIN_ResBlock(64)
        self.ain_rb4_3 = AIN_ResBlock(64)

        self.res_up2 = ResUpsampleSum(32, 64)
        self.ain_rb5_1 = AIN_ResBlock(32)
        self.ain_rb5_2 = AIN_ResBlock(32)

        self.conv_out = nn.Conv2d(32, out_nc, 3, 1, 1, bias=True)
        self.relu = nn.ReLU()
...
class AINDNet(nn.Module):
    def __init__(self, in_nc, out_nc):
        ...
        self.ainnet = AINDNet_recon(in_nc, out_nc)
